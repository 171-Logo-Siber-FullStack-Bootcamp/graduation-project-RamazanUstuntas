    ...
    <div class="container-fluid py-5">
      <div class="row d-flex">
        <div class="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 order-sm-0 order-12" style="margin-right:-120px;">
          <img class="img-fluid" src="https://cdn-nq.logo.com.tr/assets/images/banners/banner-cover-ik-web.jpg">
        </div>
        <div class="col-12 col-xl-6 col-lg-5 col-md-6 col-sm-12 order-first order-xl-0">
          <h1>Hello there</h1>
          <h2 style="color:grey">Would you like to contact us about our products?</h2>
          <form>
